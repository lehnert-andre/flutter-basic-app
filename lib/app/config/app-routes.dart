...
import 'package:flutter_basic_app/app/authentication/screens/login.screen.dart';
...
class Routes {
  ...
  static final Route LOG_IN = Route("/login", "Login", Icons.person); // ignore: non_constant_identifier_names
  ...
  static void configureRoutes(Router router) {
    ...
    router.define(LOG_IN.namedRoute, handler: _logInScreenRoute, transitionType: TransitionType.inFromRight);
  ...
  static final _logInScreenRoute = Handler(handlerFunc: (_, __) {
    return LogInScreen();
  });
